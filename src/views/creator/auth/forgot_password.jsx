...
import { createForgotPasswordValidation } from '../../../validations/creator_auth';
...
export default function ForgotPassword() {
    ...
    const onSubmit = async (e) => {
        try {
            e.preventDefault();
            const { isValid, errors } = createForgotPasswordValidation(formData);
            if (!isValid) {
                setErrors(errors);
                return
            }
            ...
            await creatorForgetPassword(formData)
