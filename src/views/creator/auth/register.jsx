...
export default function Register() {
    ...
    const onRegister = async (e) => {
        try {
            e.preventDefault()
            const { errors, isValid } = creatorRegisterValidation(formData);
            if (!isValid) {
                setErrors(errors);
                return;
            }
                                ...
                                <div className="mb-2">
                                    <input
                                        ...
                                        className={`w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color
                                            placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary ${errors.name ? "border-red-500" : "border-[#E9EDF4]"
                                            }`}
                                        value={formData.name}
                                ...
                                <div className="mb-2">
                                    <input
                                        ...
                                        className={`w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color
                                            placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary ${errors.email ? "border-red-500" : "border-[#E9EDF4]"
                                            }`}
                                ...
                                <div className="mb-2">
                                    <input
                                        ...
                                        className={`w-full
                                            ...
                                            focus:border-primary ${errors.password ? "border-red-500" : "border-[#E9EDF4]"
                                            }`}
                                ...
                                <div className="mb-6">
                                    <input
                                        ...
                                        className={`w-full
                                                ...
                                                outline-none
                                                focus-visible:shadow-none
                                                focus:border-primary ${errors.confirm_password
                                                ? "border-red-500"
                                                : "border-[#E9EDF4]"
                                            }`}
