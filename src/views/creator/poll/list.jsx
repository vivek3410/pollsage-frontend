...
import { deletePoll, getListOfPolls } from '../../../services/creator/poll.service';
...
export default function PollList() {
    ...
    const handleDeletePoll = async (pollId) => {
        try {
            let confirm = window.confirm("Are you sure you want to delete this poll?");
            if (!confirm) return
    ...
    return (
        <>
            <PageDetails title="Poll list - PollSage" description="poll list" />
            <div className="mb-6 flex items-center justify-between">
                <h1 className="text-slate-800 font-bold text-3xl">
                    Poll list
                </h1>
                <div className="grid auto-cols-max justify-end grid-flow-col gap-4">
